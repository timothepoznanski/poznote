...
function poznoteCssGroups(): array
{
    return [
        ...
        // The Settings frame (settings_shell.php) around the pages opened
        // from settings.php: its font (Inter, as on settings.php), the filter
        // field and the section list.
        '@settings-shell' => [
            'css/fonts.css',
            'css/home/search.css',
            'css/settings.css',
