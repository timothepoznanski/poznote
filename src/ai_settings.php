            ...
            <form method="post">
                ...
                <div class="git-config-fields">
                    ...
                    <div class="git-field-group">
                        ...
                        <select name="ai_model" id="ai_model" class="git-field-input" <?php echo $aiConfig['ai_chat_model'] === '' ? 'hidden' : ''; ?>>
                            <?php if ($aiConfig['ai_chat_model'] !== ''): ?>
                            <option value="<?php echo htmlspecialchars($aiConfig['ai_chat_model']); ?>" selected><?php echo htmlspecialchars($aiConfig['ai_chat_model']); ?></option>
                            <?php endif; ?>
                        </select>
                        <p class="config-hint config-hint-error" id="ai-model-empty-msg" <?php echo $aiConfig['ai_chat_model'] === '' ? '' : 'hidden'; ?>><?php echo t_h('ai_settings.model_empty_hint', ['button' => t('ai_settings.test', [], 'Check access and list models')], 'Click "{{button}}" above, then select one.'); ?></p>
                    </div>
