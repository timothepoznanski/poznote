...
try {
    ...
    $openai_data = [
        ...
        'messages' => [
            [
                'role' => 'system',
                'content' => 'You are an assistant that helps summarize notes. Create a concise and informative summary of the provided note. The summary should capture the key points and important information. Respond in English unless the note is clearly in another language.'
            ],
            [
                'role' => 'user',
