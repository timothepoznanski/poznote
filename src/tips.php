    ...
    <div class="tips-container">
        ...
        <div class="tips-content">
            <div class="tips-list">
                ...
                <div style="padding-left: 40px; margin-top: 10px; margin-bottom: 15px;">
                    <img src="https://raw.githubusercontent.com/timothepoznanski/poznote/dev/readme/tips/tip2.png" alt="Search across multiple keywords" class="tip-image" style="display: block; max-width: 60%; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.1);" />
                </div>
                <div class="tip-item">
