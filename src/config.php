...
define('OIDC_ISSUER', rtrim($_ENV['POZNOTE_OIDC_ISSUER'] ?? getenv('POZNOTE_OIDC_ISSUER') ?? '', '/'));
// Or provide the discovery URL directly
define('OIDC_DISCOVERY_URL', $_ENV['POZNOTE_OIDC_DISCOVERY_URL'] ?? getenv('POZNOTE_OIDC_DISCOVERY_URL') ?? '');
define('OIDC_CLIENT_ID', $_ENV['POZNOTE_OIDC_CLIENT_ID'] ?? getenv('POZNOTE_OIDC_CLIENT_ID') ?? '');
define('OIDC_CLIENT_SECRET', $_ENV['POZNOTE_OIDC_CLIENT_SECRET'] ?? getenv('POZNOTE_OIDC_CLIENT_SECRET') ?? '');
define('OIDC_SCOPES', $_ENV['POZNOTE_OIDC_SCOPES'] ?? getenv('POZNOTE_OIDC_SCOPES') ?? 'openid profile email');
// If not set, redirect URI is derived from current request base URL
define('OIDC_REDIRECT_URI', $_ENV['POZNOTE_OIDC_REDIRECT_URI'] ?? getenv('POZNOTE_OIDC_REDIRECT_URI') ?? '');
// Optional: specify provider end-session endpoint (if your provider supports RP-initiated logout)
define('OIDC_END_SESSION_ENDPOINT', $_ENV['POZNOTE_OIDC_END_SESSION_ENDPOINT'] ?? getenv('POZNOTE_OIDC_END_SESSION_ENDPOINT') ?? '');
...
define('OIDC_ALLOWED_USERS', $_ENV['POZNOTE_OIDC_ALLOWED_USERS'] ?? getenv('POZNOTE_OIDC_ALLOWED_USERS') ?? '');
...
define('SETTINGS_PASSWORD', $_ENV['POZNOTE_SETTINGS_PASSWORD'] ?? getenv('POZNOTE_SETTINGS_PASSWORD') ?? '');
...
define('GITHUB_TOKEN', $_ENV['POZNOTE_GITHUB_TOKEN'] ?? getenv('POZNOTE_GITHUB_TOKEN') ?? '');
// GitHub repository (owner/repo format)
define('GITHUB_REPO', $_ENV['POZNOTE_GITHUB_REPO'] ?? getenv('POZNOTE_GITHUB_REPO') ?? '');
// GitHub branch to sync with
define('GITHUB_BRANCH', $_ENV['POZNOTE_GITHUB_BRANCH'] ?? getenv('POZNOTE_GITHUB_BRANCH') ?? 'main');
// Commit author name
define('GITHUB_AUTHOR_NAME', $_ENV['POZNOTE_GITHUB_AUTHOR_NAME'] ?? getenv('POZNOTE_GITHUB_AUTHOR_NAME') ?? 'Poznote');
// Commit author email
define('GITHUB_AUTHOR_EMAIL', $_ENV['POZNOTE_GITHUB_AUTHOR_EMAIL'] ?? getenv('POZNOTE_GITHUB_AUTHOR_EMAIL') ?? 'poznote@localhost');