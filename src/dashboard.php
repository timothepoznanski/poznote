      ...
      data-workspace="<?php echo htmlspecialchars($pageWorkspace, ENT_QUOTES, 'UTF-8'); ?>">
		...
		<div id="dashboardUserInfoModal" class="modal">
			<div class="modal-content">
				...
				<p style="margin: 16px 0; color: #4b5563; font-size: 14px; line-height: 1.5;"><?php echo t_h('modals.user_settings_info.message', [], 'You can change your username, name and password from Settings. To edit your email or OIDC Subject (UUID), please contact the administrator of this Poznote instance.'); ?></p>
				<div class="modal-buttons">
