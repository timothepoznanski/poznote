...
<body class="trash-page has-icon-sidebar" data-workspace="<?php echo htmlspecialchars($pageWorkspace, ENT_QUOTES, 'UTF-8'); ?>" data-date-time-format="<?php echo htmlspecialchars(getUserDateTimeFormat(), ENT_QUOTES, 'UTF-8'); ?>">
    ...
    <script src="<?php echo poznoteAsset('js/toolbar-popups.js'); ?>"></script>
    <script src="<?php echo poznoteAsset('js/toolbar-editor-utils.js'); ?>"></script>
    <script src="<?php echo poznoteAsset('js/toolbar-format.js'); ?>"></script>
    <script src="<?php echo poznoteAsset('js/toolbar-md-offsets.js'); ?>"></script>
    <script src="<?php echo poznoteAsset('js/toolbar-inline.js'); ?>"></script>
    <script src="<?php echo poznoteAsset('js/toolbar-emoji.js'); ?>"></script>
    <script src="<?php echo poznoteAsset('js/toolbar-links.js'); ?>"></script>
    <script src="<?php echo poznoteAsset('js/toolbar-tables.js'); ?>"></script>
