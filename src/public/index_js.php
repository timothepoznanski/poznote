...
function poznoteGetIndexJsGroups(): array {
    ...
    'head' => [
        ...
        'js/toolbar-emoji.js',
        'js/toolbar-links.js',
        'js/toolbar-tables.js',
        'js/markdown-formatting.js',
        'js/checklist.js',
        'js/bulletlist.js',
        'js/note-dom-cache.js',
        'js/note-loader.js',
        'js/note-image-menu.js',
        'js/note-content-init.js',
        'js/note-image-actions.js',
    ...
    'app' => [
        ...
        'js/attachments.js',
        'js/attachment-adoption.js',
        'js/attachment-move.js',
        ...
        'js/events-rte-setup.js',
        'js/events-rte-notes.js',
        'js/events-rte-fields.js',
        'js/events-rte-paste.js',
